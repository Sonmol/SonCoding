...
function MapleLib:Window()
    ...
    local MapleImage = Instance.new("ImageLabel")
    local Space = Instance.new("TextLabel")
    local Space2 = Instance.new("TextLabel")
    local MapleTitle = Instance.new("TextLabel")
    ...
    MapleImage.Name = "MapleImage"
    MapleImage.Parent = WindowFrame
    MapleImage.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    MapleImage.BackgroundTransparency = 1.000
    MapleImage.Position = UDim2.new(0, 3, 0, 3)
    MapleImage.Size = UDim2.new(0, 25, 0, 25)
    MapleImage.Image = "rbxassetid://8666601749"
    MapleImage.ImageColor3 = Color3.fromRGB(0,220,0)
    
    MapleTitle.Name = "MapleTitle"
    MapleTitle.Parent = WindowFrame
    MapleTitle.BackgroundColor3 = _G.WindowBackgroundColor
    MapleTitle.BackgroundTransparency = 1.000
    MapleTitle.Position = UDim2.new(0, 33, 0, 3)
    MapleTitle.Size = UDim2.new(0, 50, 0, 25)
    MapleTitle.Font = Enum.Font.GothamBold
    MapleTitle.Text = ""
    MapleTitle.TextColor3 = Color3.fromRGB(180,180,180)
    MapleTitle.TextSize = 13.000
    MapleTitle.TextXAlignment = Enum.TextXAlignment.Left
    ...
    spawn(function()
        while task.wait() do
            titlefunc:Refresh("") wait(.2) titlefunc:Refresh("M") wait(.2) titlefunc:Refresh("Ma") wait(.2) titlefunc:Refresh("Map") wait(.2) titlefunc:Refresh("Mapl") wait(.2) titlefunc:Refresh("Maple") wait(.2) titlefunc:Refresh("Maple ") wait(.2) titlefunc:Refresh("Maple H") wait(.2) titlefunc:Refresh("Maple Hu") wait(.2) titlefunc:Refresh("Mpale Hub") wait(.9) titlefunc:Refresh("Maple Hu") wait(.2) titlefunc:Refresh("Maple H") wait(.2) titlefunc:Refresh("Maple ") wait(.2) titlefunc:Refresh("Maple") wait(.2) titlefunc:Refresh("Mapl") wait(.2) titlefunc:Refresh("Map") wait(.2) titlefunc:Refresh("Ma") wait(.2) titlefunc:Refresh("M") wait(.2) titlefunc:Refresh("") wait(.2) wait(.3)
        end
    end)
    -- End Windows --
    
    -- Notification --
    function MapleLib:Notification(titledesc, textdesc)
